...
export const siteConfig: SiteConfig = {
	...
	// 站点副标题
	subtitle: "只愿在互联网中留下存在的痕迹",

	// 站点 URL
	site_url: "https://shiulog.top",

	// 站点描述
	description:
		"小鳥遊詩雨の境界線是一个基于Astro框架的个人博客网站，旨在分享技术文章、ACGN相关内容以及个人兴趣爱好。本站点提供丰富的功能和自定义选项，致力于为访问者提供良好的阅读体验。",
	...
	navbar: {
		...
		logo: {
			type: "image",
			value: "assets/images/marunana.png",
			alt: "Ⅶ",
		},
		// 导航栏标题
		title: "小鳥遊詩雨の境界線",
