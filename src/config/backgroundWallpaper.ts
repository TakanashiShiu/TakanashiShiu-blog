...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/DesktopWallpaper/n1.avif",
			"assets/images/DesktopWallpaper/n2.avif",
			"assets/images/DesktopWallpaper/n3.avif",
			"assets/images/DesktopWallpaper/n4.avif",
			"assets/images/DesktopWallpaper/n5.avif",
			"assets/images/DesktopWallpaper/n6.avif",
		],
		// 移动背景图片（支持单张或多张随机）
		...
		mobile: [
			...
			"assets/images/MobileWallpaper/w6.avif",
		],
		// 背景视频播放地址
